package net.nico.minecraftlauncher.ui;

import net.nico.minecraftlauncher.Launcher;
import net.nico.minecraftlauncher.ui.panel.IPanel;
import net.nico.minecraftlauncher.ui.panels.partials.TopBar;
...
public class PanelManager {
  ...
  public void init() {
    ...
    this.stage.getIcons().add(new Image("images/iconbig.png"));
