...
import net.nico.minecraftlauncher.ui.panels.pages.content.ContentPanel;
import net.nico.minecraftlauncher.ui.panels.pages.content.Home;
import net.nico.minecraftlauncher.ui.panels.pages.content.Settings;
...
public class App extends Panel {
  ...
  public void init(PanelManager panelManager) {
    ...
    MaterialDesignIconView homeIcon = new MaterialDesignIconView<>(MaterialDesignIcon.H.HOME);
    homeIcon.setFill(Color.WHITE);
    homeBtn.setGraphic(homeIcon);
    setCanTakeAllSize(homeBtn);
    setTop(homeBtn);
    homeBtn.setTranslateY(120d);
    ...
    MaterialDesignIconView settingsIcon = new MaterialDesignIconView<>(MaterialDesignIcon.C.COG);
    settingsIcon.setFill(Color.WHITE);
    settingsBtn.setGraphic(settingsIcon);
    setCanTakeAllSize(settingsBtn);
    setTop(settingsBtn);
    settingsBtn.setTranslateY(160d);
    ...
    if (Launcher.getInstance().getAuthInfos() != null) {
      ...
      String avatarUrl = "https://minotar.net/avatar/" + (saver.get("offline-username") != null ? "MHF_Steve.png"
