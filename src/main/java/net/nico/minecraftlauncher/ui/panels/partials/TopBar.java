package net.nico.minecraftlauncher.ui.panels.partials;
...
public class TopBar extends Panel {
  ...
  public void init(PanelManager panelManager) {
    ...
    fullscreenBtn
        .setOnMouseClicked(e -> this.panelManager.getStage().setMaximized(!this.panelManager.getStage().isMaximized()));
